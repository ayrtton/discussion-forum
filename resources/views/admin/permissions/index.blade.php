            ...
            <tbody>
                @foreach ($permissions as $permission)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.permissions.edit', $permission->id) }}" class="edit-restore-button">Edit</a>&nbsp;
                            <form class="delete-form" action="{{ route('admin.permissions.destroy', $permission->id) }}" method="POST"
